...
class PortfolioSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $skillCategories = [
            ...
            'NestJS' => ['backend', 'application', 'ai', 'architecture'],
            ...
            'Livewire' => ['backend', 'architecture', 'frontend', 'web'],
            'Filament' => ['backend', 'architecture', 'frontend', 'web', 'tools'],
            ...
            'Express.js' => ['backend', 'ai', 'web'],
            'Prisma' => ['backend', 'database', 'programming'],
            'TypeORM' => ['backend', 'database', 'programming'],
